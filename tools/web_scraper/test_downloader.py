...
class TestDownloader:
    ...
    def __init__(self, auth_session, downloads_path: str = "../../data/downloads"):
        """
    ...
    def parse_tests_table(self, table_html: str) -> List[Dict[str, Any]]:
        ...
        """
        try:
            logger.info("Парсинг таблицы тестов...")
            ...
            logger.info(f"Найдено строк таблицы: {len(rows)}")
    ...
    def get_test_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if stats['oldest_date'] and stats['newest_date']:
                ...
                stats['date_range'] = (newest - oldest).days
